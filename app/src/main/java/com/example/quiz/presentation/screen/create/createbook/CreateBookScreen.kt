...
@Composable
fun CreateBookScreen(modifier: Modifier = Modifier, viewModel: CreateBookViewModel = viewModel()) {
    ...
    Column(
        ...
        SimpleOutlinedText(
            modifier = Modifier.padding(top = 20.dp).width(355.dp),
            title.value,
            "Название",
            { title.value = it },
...
private fun CreateBookPreview() {
    QuizTheme { CreateBookScreen(Modifier) }
